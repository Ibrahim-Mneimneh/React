...
class RandomQuotes extends React.Component{
  ...
  render(){
    ...
    <div>
      ...
      <QuoteText id="text" quoteText={this.state.text}/>
      <QuoteAuthor id="author" quoteAuthor={this.state.author} />
      <button id="new-quote" onClick={this.handleChange} className="btn btn-default">New Quote</button>
      <a href="twitter.com/intent/tweet" id="tweet-quote"><button>Twitter</button></a>
    </div>
