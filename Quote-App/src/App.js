...
class RandomQuotes extends React.Component{
  ...
  render(){
    return(
        <div style={{backgroundColor:colorArray[this.state.color]}} className="k">
        <div style={{color:colorArray[this.state.color]}} className="quote-box">
      <QuoteText quoteText={this.state.text}/>
      <QuoteAuthor quoteAuthor={this.state.author} />
      <button id="new-quote" style={{backgroundColor:colorArray[this.state.color]}} onClick={this.handleChange}>New Quote</button>
      <a href="https://twitter.com/?lang=en" id="tweet-quote"><button type="button" className="tweet-quote" style={{backgroundColor:colorArray[this.state.color]}}><img src="https://www.edigitalagency.com.au/wp-content/uploads/Twitter-logo-png-icon-extra-small.png" className='twitter-logo' alt='No twitter'/></button></a>
        </div>
        </div>
    )
  }
